...
public class BookDAOImpl implements BookDAO {
	...
	public void addBook(Book book) {
		...
		Object[] bookArray= {book.getTitle(),book.getBookid(),book.getAuthor(),book.getCategory(),book.getPrice()};
	...
	public List<Book> getBookbycategory(String category) {
		...
		List<Book> bookList=jdbcTemplate.query(query,new Object[] {category},(rs,rowNum) ->
			{
				Book book  = new Book();
				String title = rs.getString("title");
				book.setTitle(title);
	...
	public Book getBookById(int bookid) {
		...
		Book newBook=jdbcTemplate.queryForObject(query,new Object[] {bookid},(rs,rowNum)->{
			Book book  = new Book();
			String title = rs.getString("title");
			book.setTitle(title);
			book.setBookid(rs.getInt("bookid"));
